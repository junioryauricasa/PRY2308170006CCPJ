    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="nav-tabs-custom">
              ...
              <div class="box-body">
                  <div class="callout callout-danger">
                      <h4>CRONOGRAMA DE PROCESO DE CERTIFICACIÓN:</h4>
                        <p>
                            Presentación de expedientes: De acuerdo a la programación del proceso de certificación se procederá a dar la fecha y hora en la que se presentará el expediente. (No habrá prórroga de fecha ni hora). 
                            <br>
                            Conferencia sobre “Ética profesional del Contador Público Colegiado” la conferencia se realizará de acuerdo a la programación de la siguiente certificación en el Auditorio del CCPJ.
                        </p>
                  </div>
          ...
          <section class="col-lg-8 col-md-12">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs pull-right">
                  <li class="pull-left header"><i class="fa fa-list"></i> Lista de Requisitos para la Certificación</li>
                </ul>
                <div class="box-body">
                    <p>
                    ...
                    <div class="panel-group wow fadeInUp animated" id="accordion" data-wow-duration="2s" data-wow-animation-name="fadeInUp" style="visibility: visible; animation-duration: 2s; animation-name: fadeInUp;">
                          ...
                          <div class="panel panel-default">
                              ...
                              <div id="collapseOne" class="panel-collapse collapse" style="height: 0px;">
                                  <div class="panel-body panel-faq">
                                      <p>Solicitud de Certificación.</p>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                              <div class="panel-heading panel-heading-faq">
                                  <h4 class="panel-title">
                                      <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                                          3. 02 Fotografías a Color de Frente. (Clic para visualizar de que tamaño son las fotografias)
                                      </a>
                                  </h4>
                              </div>
                              ...
                              <div id="collapseThree" class="panel-collapse collapse" style="height: 0px;">
                                  <div class="panel-body panel-faq">
                                      <ul>
                                          <li>01 tamaño pasaporte.</li>
                                          <li>01 tamaño carnet.</li>
                                      </ul>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                              ...
                              <div id="collapseFour" class="panel-collapse collapse" style="height: 0px;">
                                  <div class="panel-body panel-faq">
                                      <p>La Constancia de Habilitación tiene que ser original, no se aceptarán copias.</p>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                              <div class="panel-heading panel-heading-faq">
                                  <h4 class="panel-title">
                                      <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive">
                                          5. Constancia de Fecha de colegiatura.
                                      </a>
                                  </h4>
                              </div>
                              ...
                              <div id="collapseFive" class="panel-collapse collapse" style="height: 0px;">
                                  <div class="panel-body panel-faq">
                                      <p>Copia del diploma de colegiatura.</p>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                              <div class="panel-heading panel-heading-faq">
                                  <h4 class="panel-title">
                                      <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSix">
                                          6. Declaración Jurada de no tener impedimento legal ni administrativo institucional para el ejercicio de la profesión.
                                      </a>
                                  </h4>
                              </div>
                              ...
                              <div id="collapseSix" class="panel-collapse collapse" style="height: 0px;">
                                  <div class="panel-body panel-faq">
                                      <p>declaración jurada original.</p>
                                  </div>
                              </div>
                          </div>
                              ...
                              <div class="panel-heading panel-heading-faq">
                                  <h4 class="panel-title">
                                      <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse7">
                                          7. Copia de Certificado de la Conferencia sobre el Código de Ética Profesional.
                                      </a>
                                  </h4>
                              </div>
                          ...
                          <div class="panel panel-default">
                              <div class="panel-heading panel-heading-faq">
                                  <h4 class="panel-title">
                                      <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse8">
                                          8. Copia del comprobante de pago por derecho de certificación.
                                      </a>
                                  </h4>
                              </div>
                              ...
                              <div id="collapse8" class="panel-collapse collapse">
                                  <div class="panel-body panel-faq">
                                      <p>El valor de derecho de certificación es de S/.350.00.</p>
                                  </div>
                              </div>
                          </div>
                      </div>
