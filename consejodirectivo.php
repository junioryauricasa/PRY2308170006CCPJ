<?php 
  $metadescripcion = 'Sección de consejo directivo del Colegio de Contadores Públicos de Junín';
        ...
        <div class="col-md-12">
          <div class="div-with-background-img" style="background:url('dist/img/parallax/bckgnd-ofertas-laborales.jpg'); ">
                ...
                <p class="text-center text-description-header ">
                    El Decano y El Consejo Directivo 2017 – 2018 les da la bienvenida a nuestra página web institucional
                    <br>
