<?php 
  $metadescripcion = 'Sociedad de auditoria del Colegio de Contadores Públicos de Junín';
        ...
        <div class="col-md-12">
          <div class="div-with-background-img" style="background:url('dist/img/parallax/bckgnd-ofertas-laborales.jpg'); ">
                <h1 class="text-center header-page-h1">
                    Consulta Hábil Sociedades Auditoras
                </h1>
                <p class="text-center text-description-header "> 
                    Consulta Hábil por medio de Razón Social
                </p>
          </div>
        </div>
      </div>
          ...
          <section class="col-lg-8 col-md-7">
              <div class="box box-solid">
                <div class="box-header">
                  ...
                  <h3 class="box-title">
                    Formulário de Consulta Hábil Sociedades Auditoras
                  </h3>
                </div>
                <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                              <div class="form-group">
                                <label for="nombrecontacto">Ingrese Razón Social:</label>
                              ...
                              <div class="row">
                                  <div class="col-lg-12 col-xs-12">
                                    <div class="form-group" onclick="">
                                      ...
                                      <input type="text"  class=""  style="cursor: pointer" id="randomfield" label="Presione para cambiar de Código Captcha" disabled>
                                    </div>
                                  </div>
                                  <div class="col-lg-12 col-xs-12">
                                    <div class="form-group">
