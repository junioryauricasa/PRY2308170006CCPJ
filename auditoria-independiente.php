    ...
    <div class="col-md-12">
      <div class="div-with-background-img" style="background:url('dist/img/parallax/bckgnd-eventos.jpg'); ">
            <h1 class="text-center header-page-h1">
                COMITÉ FUNCIONAL DE AUDITORÍA INDEPENDIENTE
            </h1>
            <p class="text-center text-description-header ">
                Bienvenidos a la seccion de Auditoria independiente del Colegio de Contadores Públicos de Junín. 
                <br> 
          ...
          <section class="col-lg-4 col-md-12">
            ...
            <div class="nav-tabs-custom">
              ...
              <div class="box-body">
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="fb-comments" data-href="http://ccpjunin.pe/auditoria-independiente/" data-width="100%" data-numposts="20"></div>
                    </div>
                  </div>
              </div>
            </div>
