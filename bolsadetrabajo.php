                  ...
                  <div class="box-group" id="accordion">
                    ...
                    <div class="panel box box-default">
                      <div class="box-header with-border">
                        <h4 class="">
                          <a href="#collapseOne1">
                            Convocatoria 28 de Junio del 2017 <span class="label label-default pull-right">28/06/2017</span>
                          </a>
                        </h4>
                      </div>
                      <div class="">
                        <div class="box-body">
                          <p>
                            Descripción: (Vista previa) para poder descargar el archivo completo, dar click en el siguiente enlace <b><a href="dist/docs/ofertalaboral/28-junio-Bolsa-de-trabajo.pdf" download="dist/docs/ofertalaboral/28-junio-Bolsa-de-trabajo.pdf">Descargar archivo completo</a></b>
                          </p>
                          <br> 
                          <div class="embed-responsive" style="padding-bottom:150%">
                               <object data="dist/docs/ofertalaboral/28-junio-Bolsa-de-trabajo.pdf" type="application/pdf" width="100%" height="800px" internalinstanceid="508" title=""> 
                                <p>
                                  Parece que no tiene un complemento PDF para este navegador, pero no hay problema, puedes dar 
                                 <a href="dist/docs/ofertalaboral/28-junio-Bolsa-de-trabajo.pdf">
                                   click para descargar el archivo PDF
                                 </a>
                                </p>  
                               </object>
                          </div>
                          <div class="fb-comments" data-href="http://ccpjunin.pe/imagenes/bolsatrabajo0006" data-width="100%" data-numposts="20"></div>
                        </div>
                      </div>
                    </div>
                    <!-- div bolsa trabajo -->
                    ...
                    <div class="panel box box-default">
                      ...
                      <div class="">
                        <div class="box-body">
                          <p>
                            Descripción: (Vista previa) para poder descargar el archivo completo, dar click en el siguiente enlace <b><a href="dist/docs/ofertalaboral/28-junio-2017.pdf" download="dist/docs/ofertalaboral/28-junio-2017.pdf">Descargar archivo completo</a></b>
                          </p>
                          <br> 
                          <div class="embed-responsive" style="padding-bottom:150%">
                               <object data="dist/docs/ofertalaboral/28-junio-2017.pdf" type="application/pdf" width="100%" height="800px" internalinstanceid="508" title=""> 
                                <p>
                                  Parece que no tiene un complemento PDF para este navegador, pero no hay problema, puedes dar 
                                 <a href="dist/docs/ofertalaboral/28-junio-2017.pdf">
                                   click para descargar el archivo PDF
                                 </a>
                                </p>  
                               </object>
                          </div>
                          <div class="fb-comments" data-href="http://ccpjunin.pe/imagenes/bolsatrabajo0007" data-width="100%" data-numposts="20"></div>
                        </div>
                      </div>
                    </div>
                    <!-- div bolsa trabajo -->
                    ...
                    <div class="panel box box-default">
                      <div class="box-header with-border">
                        <h4 class="">
                          <a href="#collapseOne1">
                            Convocatoria 21 de junio 2017 <span class="label label-default pull-right">21/06/2017</span>
                          </a>
                        </h4>
                      </div>
                      <div class="">
                        <div class="box-body">
                          <p>
                            Descripción: (Vista previa) para poder descargar el archivo completo, dar click en el siguiente enlace <b><a href="dist/docs/ofertalaboral/21-junio-8.pdf" download="dist/docs/ofertalaboral/21-junio-8.pdf">Descargar archivo completo</a></b>
                          </p>
                          <br> 
                          <div class="embed-responsive" style="padding-bottom:150%">
                               <object data="dist/docs/ofertalaboral/21-junio-8.pdf" type="application/pdf" width="100%" height="800px" internalinstanceid="508" title=""> 
                                <p>
                                  Parece que no tiene un complemento PDF para este navegador, pero no hay problema, puedes dar 
                                 <a href="dist/docs/ofertalaboral/21-junio-8.pdf">
                                   click para descargar el archivo PDF
                                 </a>
                                </p>  
                               </object>
                          </div>
                          <div class="fb-comments" data-href="http://ccpjunin.pe/imagenes/bolsatrabajo0008" data-width="100%" data-numposts="20"></div>
                        </div>
                      </div>
                    </div>
                    <!-- div bolsa trabajo -->
                    ...
                    <div class="panel box box-default">
                      <div class="box-header with-border">
                        <h4 class="">
                          <a href="#collapseOne1">
                            Convocatoria 16 de junio del 2017 <span class="label label-default pull-right">16/06/2017</span>
                          </a>
                        </h4>
                      </div>
                      <div class="">
                        <div class="box-body">
                          <p>
                            Descripción: (Vista previa) para poder descargar el archivo completo, dar click en el siguiente enlace <b><a href="dist/docs/ofertalaboral/12-junio-10.pdf" download="dist/docs/ofertalaboral/12-junio-10.pdf">Descargar archivo completo</a></b>
                          </p>
                          <br> 
                          <div class="embed-responsive" style="padding-bottom:150%">
                               <object data="dist/docs/ofertalaboral/16-unio-9.pdf" type="application/pdf" width="100%" height="800px" internalinstanceid="508" title=""> 
                                <p>
                                  Parece que no tiene un complemento PDF para este navegador, pero no hay problema, puedes dar 
                                 <a href="dist/docs/ofertalaboral/16-unio-9.pdf">
                                   click para descargar el archivo PDF
                                 </a>
                                </p>  
                               </object>
                    ...
                    <div class="panel box box-default">
                      <div class="box-header with-border">
                        <h4 class="">
                          <a href="#collapseOne1">
                            Convocatoria Municipalidad Provincial De Jauja <span class="label label-default pull-right">12/06/2017</span>
                          </a>
                        </h4>
                      </div>
                      <div class="">
                        <div class="box-body">
                          <p>
                            Descripción: Convocatoria Municipalidad Provincial De Jauja (Vista previa) para poder descargar el archivo completo, dar click en el siguiente enlace <b><a href="dist/docs/ofertalaboral/12-junio-10.pdf" download="dist/docs/ofertalaboral/12-junio-10.pdf">Descargar archivo completo</a></b>
                          </p>
                          <br> 
                          <div class="embed-responsive" style="padding-bottom:150%">
                               <object data="dist/docs/ofertalaboral/12-junio-10.pdf" type="application/pdf" width="100%" height="800px" internalinstanceid="508" title=""> 
                                <p>
                                  Parece que no tiene un complemento PDF para este navegador, pero no hay problema, puedes dar 
                                 <a href="dist/docs/ofertalaboral/12-junio-10.pdf">
                                   click para descargar el archivo PDF
                                 </a>
                                </p>  
                               </object>
