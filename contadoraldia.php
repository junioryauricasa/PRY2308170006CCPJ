                ...
                <div class="box-group" id="accordion">
                    ...
                    <div class="box-header with-border">
                      <h4 class="">
                        <a data-toggle="collapse" data-parent="#accordion" href="#contadoraldiapdf_00001" aria-expanded="false" class="collapsed">
                          Le sugerimos tener en cuenta las Obligaciones, requemientos y beneficios del FAM <br><span class="label label-default pull-left">08/02/2017</span>
                        </a>
                      </h4>
                    </div>
                  ...
                  <div class="panel box box-default">
                    <div class="box-header with-border">
                      <h4 class="">
                        <a data-toggle="collapse" data-parent="#accordion" href="#contadoraldiapdf_00001" aria-expanded="false" class="collapsed">
                          Publicación de la obra: "Aspectos Generales de los Procedimientos Administrativos Tributarios" <br><span class="label label-default pull-left">25/01/2017</span>
                        </a>
                      </h4>
                    </div>
                    <div id="contadoraldiapdf_00001" class="panel-collapse collapse in" aria-expanded="false" style="">
